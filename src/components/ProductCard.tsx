...
export default function ProductCard({ name, slug, price, currency, category, brand }: ProductCardProps) {
  return (
    <Link
      href={`/shop/${slug}`}
    ...
    >
      <div className="aspect-square bg-slate-mid flex items-center justify-center p-8">
